...
# 
# In this notebook, we'll be building a generative adversarial network (GAN) trained on the MNIST dataset. From this, we'll be able to generate new handwritten digits! This notebook is modified from https://github.com/udacity/deep-learning/blob/master/gan_mnist/Intro_to_GANs_Exercises.ipynb.
# 
